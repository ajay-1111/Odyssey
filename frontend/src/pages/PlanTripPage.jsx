...
export default function PlanTripPage() {
  ...
  const handleSubmit = async () => {
    ...
    try {
      ...
      // Store trip data in session storage for result page
    ...
    <div className="min-h-screen bg-[#050505]" data-testid="plan-trip-page">
      ...
      <nav className="fixed top-0 w-full z-50 bg-[#050505]/80 backdrop-blur-md border-b border-white/5">
        <div className="max-w-7xl mx-auto px-6 py-4 flex items-center justify-between">
          ...
          <Link to="/" className="text-white/70 hover:text-[#D4AF37] transition-colors font-body flex items-center gap-2">
            ...
            >
              ...
              {currentStep === 1 && (
                <div className="space-y-8">
                  <div>
                    <h2 className="font-heading text-3xl text-white mb-2">Where's your adventure?</h2>
                    <p className="text-white/50 font-body">Tell us where you're starting from and where you want to go</p>
                  </div>
                  ...
                  <div className="space-y-4">
                    <div>
                      ...
                      <div className="relative">
                        <Plane className="absolute left-4 top-1/2 -translate-y-1/2 w-5 h-5 text-white/30" />
                        <Input
                          value={departure}
                      ...
                      {destinations.map((dest, i) => (
                        <div key={i} className="relative mb-3">
                          ...
                          <Input
                            ...
                            className="pl-12 pr-12 h-14 bg-white/5 border-white/10 text-white placeholder:text-white/30 focus:border-[#D4AF37]/50"
                            data-testid={`destination-input-${i}`}
                          />
                          {destinations.length > 1 && (
                            <button
                              onClick={() => removeDestination(i)}
                              className="absolute right-4 top-1/2 -translate-y-1/2 text-white/30 hover:text-red-400"
                            >
                              <X className="w-5 h-5" />
                            </button>
                          )}
              ...
              {currentStep === 2 && (
                <div className="space-y-8">
                  <div>
                    <h2 className="font-heading text-3xl text-white mb-2">When are you traveling?</h2>
                    <p className="text-white/50 font-body">Select your travel dates</p>
                  </div>
                    ...
                    <div>
                      ...
                      <Popover>
                        <PopoverTrigger asChild>
                          <Button
                            variant="outline"
                            className="w-full h-14 justify-start text-left font-normal bg-white/5 border-white/10 text-white hover:bg-white/10"
              ...
              {currentStep === 3 && (
                <div className="space-y-8">
                  <div>
                    <h2 className="font-heading text-3xl text-white mb-2">Who's traveling?</h2>
                    <p className="text-white/50 font-body">Tell us about your travel group and budget</p>
                  </div>
                    ...
                    {[
                      ...
                      <div key={key} className="flex items-center justify-between p-4 rounded-xl bg-white/5 border border-white/10">
                        ...
                        <div className="flex items-center gap-3">
                          ...
                          <span className="w-8 text-center text-white font-heading text-xl" data-testid={`${key}-count`}>
                            {travelers[key]}
                          </span>
                          <Button
                            type="button"
                  ...
                  <div className="grid md:grid-cols-2 gap-6 pt-6 border-t border-white/10">
                    ...
                    <div>
                      ...
                      <Select value={currency} onValueChange={setCurrency}>
                        <SelectTrigger className="h-14 bg-white/5 border-white/10 text-white" data-testid="currency-select">
                          <SelectValue />
                        </SelectTrigger>
                  ...
                  {totalTravelers > 0 && budget > 0 && (
                    <div className="p-4 rounded-xl bg-[#D4AF37]/10 border border-[#D4AF37]/20">
                      <p className="text-[#D4AF37] font-body text-center">
                        ~{currency} {Math.round(budget / totalTravelers).toLocaleString()} per person
                      </p>
                    </div>
                  )}
                </div>
              ...
              {currentStep === 4 && (
                <div className="space-y-8">
                  <div>
                    <h2 className="font-heading text-3xl text-white mb-2">Personalize your trip</h2>
                    <p className="text-white/50 font-body">Help us tailor recommendations to your preferences</p>
                  </div>
                  ...
                  <div>
                    ...
                    <Select value={foodPreference} onValueChange={setFoodPreference}>
                      <SelectTrigger className="h-14 bg-white/5 border-white/10 text-white" data-testid="food-preference-select">
                        <div className="flex items-center gap-3">
                  ...
                  <div>
                    ...
                    <Select value={accommodationType} onValueChange={setAccommodationType}>
                      <SelectTrigger className="h-14 bg-white/5 border-white/10 text-white" data-testid="accommodation-select">
                        <div className="flex items-center gap-3">
